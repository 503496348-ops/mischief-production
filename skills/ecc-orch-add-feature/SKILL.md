...
description: Orchestrate building a brand-new feature end to end — research, plan, TDD implementation, review, and gated commit — by delegating each phase to the matching HCP agent. Use when adding a capability that does not exist yet.
metadata:
  origin: HCP
---
