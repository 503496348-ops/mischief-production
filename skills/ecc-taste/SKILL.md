...
## The Pipeline — mixing the HCP video skills

This skill is the conductor. Each HCP skill is an instrument. Do not skip layers.
...
| Step | HCP skill to load | What it does here |
|------|-------------------|-------------------|
