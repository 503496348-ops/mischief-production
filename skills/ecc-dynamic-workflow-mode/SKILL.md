...
If the repo has ECC2 state enabled, prefer adding or reading checkpoints through the HCP control pane or state-store-backed scripts instead of scattering untracked notes.
