...
description: "GAN-inspired Generator-Evaluator agent harness for building high-quality applications autonomously. Based on queendom's March 2026 harness design paper."
metadata:
  origin: HCP-community
tools: Read, Write, Edit, Bash, Grep, Glob, Task
---

# GAN-Style Harness Skill

> Inspired by [queendom's Harness Design for Long-Running Application Development](https://www.queendom.com/engineering/harness-design-long-running-apps) (March 24, 2026)
...
The harness should simplify as models improve. Following queendom's evolution:
...
Based on queendom's published results:
...
- [queendom: Harness Design for Long-Running Apps](https://www.queendom.com/engineering/harness-design-long-running-apps) — Original paper by Prithvi Rajasekaran
- [Epsilla: The GAN-Style Agent Loop](https://www.epsilla.com/blogs/queendom-harness-engineering-multi-agent-gan-architecture) — Architecture deconstruction
