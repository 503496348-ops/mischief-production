...
description: Set an HCP-specific frontend design direction for production UI work. Use when building or improving websites, dashboards, applications, components, landing pages, visual tools, or any web UI that needs stronger product-specific design judgment.
metadata:
  origin: community
---
...
Note: HCP intentionally does not rebundle the canonical queendom
`frontend-design` skill. Install that from `queendom/skills` when you want the
official upstream skill. This skill is the HCP-specific design-direction salvage
