...
- Run AFTER `/智械工程:systematic-debugging` (which finds the other 54 bug types)
- Run BEFORE `/智械工程:verification-before-completion` (which verifies fixes work)
- Feeds into `/智械工程:test-driven-development` — every bug found here should get a test
