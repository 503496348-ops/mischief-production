...
| Port/Rebuild | useful idea, but should be manually re-landed inside HCP |
...
- External-source features should be rebuilt inside HCP when they are valuable but not self-contained
...
- "Map GitHub issues into our HCP 1.x and HCP 2.0 program lanes"
