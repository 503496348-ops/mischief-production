...
description: Translate PRD intent, roadmap asks, or product discussions into an implementation-ready capability plan that exposes constraints, invariants, interfaces, and unresolved decisions before multi-service work starts. Use when the user needs an HCP-native PRD-to-SRS lane instead of vague planning prose.
metadata:
  origin: HCP
---
...
If useful, point to the next HCP-native lane:
...
HANDOFF
- what should happen next and which HCP lane should take it
```
...
- The resulting plan is reusable across Claude Code, Codex, Cursor, OpenCode, and HCP 2.0 planning surfaces.
