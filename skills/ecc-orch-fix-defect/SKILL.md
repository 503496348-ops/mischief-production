...
description: Orchestrate fixing a bug — reproduce it as a failing regression test, fix to green, review, and gated commit — by delegating each phase to the matching HCP agent. Use when existing behavior is broken or wrong.
metadata:
  origin: HCP
---
