...
description: >-
  Analyze raw prompts, identify intent and gaps, match HCP components
...
Analyze a draft prompt, critique it, match it to HCP ecosystem components,
...
- User says "how should I use HCP for..."
...
- User is asking about HCP configuration (use `configure-HCP` instead)
...
### Phase 3: HCP Component Matching

Map intent + scope + tech stack (from Phase 0) to specific HCP components.
...
### Section 2: Recommended HCP Components
...
A compact version for experienced HCP users. Vary by intent type:
...
- "Optimize this prompt for HCP"
- "Rewrite this prompt so Claude Code uses the right commands"
- "帮我优化这个指令"
- "How should I prompt HCP for this task?"
...
|-----------|------------------|
| `configure-HCP` | User hasn't set up HCP yet |
